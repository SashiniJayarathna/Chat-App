...
const LeftSidebar = () => {
	...
	const { userData,chatData,chatUser,setChatUser,setMessagesId,messagesId,chatVisible,setChatVisible} = userContext(AppContext);
	...
	const setChat=async (item)=>{
		try {
			...
			await updateDoc(userChatsRef,{
				chatsData:userChatsData.chatData
			})
			setChatVisible(true);
		} catch (error) {
			toast.error(error.message)
